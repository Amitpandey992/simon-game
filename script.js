...
/* when user tap into the wrong sequence of color then this function reset the value of the level as well gamepattern which shows the color sequences for user to tap */
function startOver() {
  level = 0;
  gamePattern = [];
  started = false;
